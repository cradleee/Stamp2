...
//  Stamp2
//
//  Created by kamano yurika on 2018/02/11.
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerControllerDidCancel(_ picker: UIImagePickerController, did_FinishPickMediaWithInfo info: [String : Any]) {
